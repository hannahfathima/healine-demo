...
export const AddDepartmentWorkingHours = (props) => {
  ...
  const handleSubmit = async (values) => {
    ...
    if (result.status === 200) {
      ...
      navigate(`/departments/manage-hours/${departmentId}`);
    } else {
  ...
  return (
    <div className="min-width">
      ...
      >
        <h4 className="pagename-heading ml-0">Add Department Hours</h4>
      </div>
      <Formik
