...
import { AddSpecialityValidator } from "../../shared/validations/CommonValidations";
import { specTierData } from "../../utils/jsonData";

export const AddSpeciality = (props) => {
  ...
  return (
    <div className="min-width">
      ...
      >
        <h4 className="pagename-heading ml-0">Add Speciality</h4>
      </div>
      <Formik
        ...
        validationSchema={AddSpecialityValidator}
      >
        {(props) => {
              ...
              <form onSubmit={handleSubmit} noValidate>
                <Grid container spacing={2} alignItems="flex-start">
                  ...
                  <Grid item lg={6}>
                    ...
                    />
                    <ErrorMessage name="icon" component={ShowInputError} />
                  </Grid>
